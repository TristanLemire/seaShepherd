...
router.get('/:id', (req, res) => {
    queries.getWhere('questions', req.params.id).then(sticker => {
...
router.get('/', (req, res) => {
    queries.getAll('questions').then(response => {
        res.json(response);
    })
})
...
router.post('/', (req, res, next) => {
    //insert into db
    queries.create('questions', req.body).then(response => {
        res.json(response);
    })
})
...
router.put('/:id', (req, res, next) => {
    // update the db
    queries.update('questions', req.params.id, req.body).then(stickers => {
...
router.delete('/:id', (req, res, next) => {
    queries.delete('questions', req.params.id).then(() => {
        res.json({
            deleted: true
        })
    })
